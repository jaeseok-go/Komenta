...
public class VodDetailDTO {
    ...
    public VodDetailDTO(int ve_id, int ve_episode_num, String ve_contents, String ve_admin, String ve_upload_date,
                        int v_id, int vh_id, String vh_watching_time, String v_title, String v_summary, String v_director,
                        String v_actors, int v_age_grade, String v_poster, int gd_id, String g_name, String gd_name) {
        this.ve_id = ve_id;
