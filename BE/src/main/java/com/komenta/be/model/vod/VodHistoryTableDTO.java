...
public class VodHistoryTableDTO {
    private int vh_id;
    ...
    public VodHistoryTableDTO(String vh_watching_time, String vh_comment, int vh_score, boolean vh_good, int u_id, int ve_id) {
    ...
    public VodHistoryTableDTO(int vh_id, String vh_watching_time, String vh_comment, int vh_score, boolean vh_good, int u_id, int ve_id) {
        this.vh_id = vh_id;
        this.vh_watching_time = vh_watching_time;
        this.vh_comment = vh_comment;
        this.vh_score = vh_score;
